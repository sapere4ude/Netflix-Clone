...
struct Constants {
    static let API_KEY = "95ac46ab6ea20b1e4e25ce46fcaf556f"
    static let baseURL = "https://api.themoviedb.org"
    static let YoutubeAPI_KEY = "AIzaSyCEL9ZEFD9An6ASn3kwM4ViSITaFet1ack"
...
class APICaller {
    ...
    func getTrendingMoviews(completion: @escaping (Result<[Title], Error>) -> Void) {
    ...
    func getDiscoverMove(completion: @escaping (Result<[Title], Error>) -> Void) {
